...
export default function StatsCards({ stats, formatCurrency }: StatsCardsProps) {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      <div className={`bg-gradient-to-br from-blue-600 to-blue-700 hover:from-blue-500 hover:to-blue-600 rounded-2xl p-5 shadow-lg border border-blue-400/20 hover:scale-[1.015] hover:shadow-xl transition-all duration-300 group relative overflow-hidden ${styles.glowBlue}`}>
      ...
      <div className={`bg-gradient-to-br from-emerald-600 to-emerald-700 hover:from-emerald-500 hover:to-emerald-600 rounded-2xl p-5 shadow-lg border border-emerald-400/20 hover:scale-[1.015] hover:shadow-xl transition-all duration-300 group relative overflow-hidden ${styles.glowGreen}`}>
        <div className="absolute top-0 right-0 p-3 opacity-10 group-hover:scale-110 transition-transform duration-300">
          <svg className="w-20 h-20 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className={`bg-gradient-to-br from-rose-600 to-rose-700 hover:from-rose-500 hover:to-rose-600 rounded-2xl p-5 shadow-lg border border-rose-400/20 hover:scale-[1.015] hover:shadow-xl transition-all duration-300 group relative overflow-hidden ${styles.glowRed}`}>
        <div className="absolute top-0 right-0 p-3 opacity-10 group-hover:scale-110 transition-transform duration-300">
          <svg className="w-20 h-20 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className={`bg-gradient-to-br from-cyan-500 to-cyan-600 hover:from-cyan-400 hover:to-cyan-500 rounded-2xl p-5 shadow-lg border border-cyan-300/20 hover:scale-[1.015] hover:shadow-xl transition-all duration-300 group relative overflow-hidden ${styles.glowCyan}`}>
        <div className="absolute top-0 right-0 p-3 opacity-10 group-hover:scale-110 transition-transform duration-300">
          <svg className="w-20 h-20 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
