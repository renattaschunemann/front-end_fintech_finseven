...
export default function CategoriasPage() {
  ...
  const filteredTransactions = useMemo(() => {
    return transactions.filter((tx) => {
      ...
      const todayTime = new Date("2026-05-22").getTime();
  ...
  return (
    <div className={`flex h-screen w-screen transition-colors duration-300 overflow-hidden font-sans select-none animate-fade-in ${theme === "dark" ? "bg-[#0b0f19] text-slate-100" : "bg-[#f8fafc] text-slate-800"
      }`}>
      {toast && (
      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-y-auto animate-fade-in">
        ...
        <div className="p-6 space-y-6 max-w-7xl mx-auto w-full">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 border-b border-slate-800/25 pb-4">
            ...
            <button
              onClick={() => router.push("/")}
              className={`text-xs font-semibold px-4 py-2.5 rounded-xl flex items-center gap-1.5 transition-all border cursor-pointer ${theme === "dark"
          ...
          <div className="flex justify-center w-full">
            { }
            <div className={`w-full max-w-2xl backdrop-blur-md border rounded-2xl p-6 shadow-md transition-all ${theme === "dark" ? "bg-[#101422]/70 border-slate-800/40 shadow-2xl shadow-black/30" : "bg-white border-slate-200 shadow-sm"
              }`}>
              ...
              <div className="space-y-4">
                { }
                <div>
                  <label className={`text-[10px] font-bold uppercase tracking-wider block mb-2.5 ${theme === "dark" ? "text-slate-400" : "text-slate-500"
                    }`}>
                    Fluxo Financeiro
                  </label>
                  <div className="grid grid-cols-3 gap-2">
                    <button
                      ...
                      className={`py-3 px-3 rounded-xl text-xs font-extrabold tracking-wide transition-all flex flex-col items-center gap-1 cursor-pointer border ${selectedType === "Receitas"
                    ...
                    <button
                      ...
                      className={`py-3 px-3 rounded-xl text-xs font-extrabold tracking-wide transition-all flex flex-col items-center gap-1 cursor-pointer border ${selectedType === "Despesas"
                    ...
                    <button
                      ...
                      className={`py-3 px-3 rounded-xl text-xs font-extrabold tracking-wide transition-all flex flex-col items-center gap-1 cursor-pointer border ${selectedType === "Investimentos"
                ...
                <div>
                  ...
                  {selectedType === "Investimentos" ? (
                    <select
                      ...
                      className={`w-full px-4 py-3 rounded-xl border text-sm font-semibold transition-all outline-none cursor-pointer ${theme === "dark"
                ...
                { }
                <form onSubmit={handleSaveCustomCategory} className={`border border-dashed p-4 rounded-xl space-y-3 mt-4 ${theme === "dark" ? "border-slate-800/60 bg-slate-900/10" : "border-slate-200 bg-slate-50/50"
                  }`}>
                  <div>
                    <label className={`text-[10px] font-bold uppercase tracking-wider block mb-1.5 ${theme === "dark" ? "text-slate-400" : "text-slate-500"
                      }`}>
                    ...
                    <div className="flex gap-2">
                      <input
                        ...
                        className={`flex-1 px-4 py-2.5 rounded-xl border text-xs font-semibold transition-all outline-none ${theme === "dark"
                ...
                <div className={`mt-6 pt-5 border-t ${theme === "dark" ? "border-slate-800/60" : "border-slate-200"}`}>
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className={`text-[10px] px-2 py-0.5 rounded-full font-bold ${theme === "dark" ? "bg-[#070b13] text-slate-400 border border-slate-800" : "bg-slate-100 text-slate-500 border border-slate-200"
                      }`}>
                  ...
                  <div className="relative mb-3">
                    <input
                      ...
                      className={`w-full pl-9 pr-4 py-2.5 rounded-xl border text-xs font-semibold transition-all outline-none ${theme === "dark"
                    ...
                    {customCategories[selectedType].length === 0 ? (
                      ...
                      (() => {
                        ...
                        return filtered.map((cat) => (
                          <div
                            key={cat.id}
                            className={`flex items-center justify-between p-2.5 rounded-xl border transition-all ${theme === "dark"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className={`backdrop-blur-md border rounded-2xl p-5 shadow-sm transition-all ${theme === "dark" ? "bg-[#101422]/70 border-slate-800/40" : "bg-white border-slate-200 shadow-sm"
              }`}>
              <div className="flex items-center justify-between">
                ...
                <div className={`p-2 rounded-xl ${selectedType === "Receitas"
              ...
              <div className="mt-3">
                <span className={`text-2xl font-black ${selectedType === "Receitas"
                    ? "text-emerald-450"
                    : selectedType === "Despesas"
                      ? "text-rose-450"
                      : "text-cyan-400"
          ...
          { }
          <div className={`backdrop-blur-md border rounded-2xl p-6 shadow-md transition-all ${theme === "dark" ? "bg-[#101422]/70 border-slate-800/40" : "bg-white border-slate-200 shadow-sm"
            }`}>
            <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-4 mb-6">
              ...
              <div className="flex flex-wrap items-center gap-3">
                { }
                <div className={`flex rounded-xl p-1 border ${theme === "dark" ? "bg-[#070b13]/80 border-slate-800/50" : "bg-slate-100/80 border-slate-200"
                  }`}>
                  {[
                    { id: "30", label: "30 dias" },
                    { id: "60", label: "60 dias" },
                    ...
                    <button
                      ...
                      className={`text-xs px-3 py-1.5 rounded-lg font-bold transition-all cursor-pointer select-none ${dateFilter === preset.id
                          ? theme === "dark"
                ...
                {dateFilter === "custom" && (
                  <div className="flex items-center gap-2 animate-fade-in">
                    <input
                      ...
                      className={`px-3 py-1.5 rounded-lg border text-xs font-bold transition-all outline-none cursor-pointer ${theme === "dark"
            ...
            { }
            <div className={`w-full overflow-x-auto rounded-xl border ${theme === "dark" ? "border-slate-800/30" : "border-slate-200"
              }`}>
              <table className="w-full text-left border-collapse min-w-[600px]">
                <thead>
                  <tr className={`text-[10px] font-bold uppercase tracking-wider border-b ${theme === "dark" ? "bg-slate-900/60 text-slate-400 border-slate-800/40" : "bg-slate-50 text-slate-500 border-slate-200"
                    }`}>
                ...
                <tbody className={`divide-y text-xs font-semibold ${theme === "dark" ? "divide-slate-800/30 text-slate-350" : "divide-slate-100 text-slate-700"
                  }`}>
                  {filteredTransactions.length === 0 ? (
                    ...
                    filteredTransactions.map((tx) => {
                      ...
                      return (
                        <tr
                          key={tx.id}
                          className={`transition-colors duration-150 group ${theme === "dark" ? "hover:bg-slate-800/20" : "hover:bg-slate-50"
                            }`}
                        >
                          ...
                          <td className="px-6 py-4">
                            <span className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[9px] uppercase font-extrabold tracking-wider ${tx.type === "Investimentos"
                          ...
                          <td className="px-6 py-4 text-right">
                            <button
                              ...
                              className={`bg-transparent text-[10px] font-bold px-2 py-1.5 rounded-lg transition-all cursor-pointer border ${theme === "dark"
      ...
      <button
        onClick={toggleTheme}
        className={`fixed bottom-6 right-6 z-30 h-12 w-12 rounded-full flex items-center justify-center shadow-lg transition-all duration-300 hover:scale-105 cursor-pointer group ${theme === "dark"
